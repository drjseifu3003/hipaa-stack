# HIPAA-Compliant VPC Service
# Aligns with HIPAA Safeguards: 164.312(a)(1) Access Control, 164.312(e)(1) Transmission Security
...
# --- VPC Endpoints for S3, KMS, Secrets Manager, Bedrock ---
