# AWS HealthLake FHIR Datastore Service
...
- **Audit Trails**: Integrates natively with CloudTrail (via the AWS audit-logging service) to log all datastore transactions, searches, and data access.

## Usage Example

```hcl
module "fhir_store" {
  source = "github.com/momentum-ai/hipaa-stack//services/healthcare-store/aws"
