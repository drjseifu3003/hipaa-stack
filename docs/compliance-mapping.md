...
This document provides a detailed mapping of the **HIPAA Security Rule Technical Safeguards (45 CFR § 164.312)** to the AWS Terraform modules provided in this repository.

## Compliance Safeguards Matrix

| HIPAA Safeguard | Requirement Summary | AWS Module & Resource Mapping |
| :--- | :--- | :--- |
...
- **Customer Managed Keys (CMKs)**: All modules enforce Customer Managed Keys created in AWS KMS, with automatic annual key rotation enabled.
